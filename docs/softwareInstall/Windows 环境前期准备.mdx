...
<img src={require('@site/static/img/softwareInstall/37.png').default} alt=""/>
<br /><br /><br />
...
<img src={require('@site/static/img/softwareInstall/38.png').default} alt=""/>

<br /><br /><br />
修改后再次打开Control Userpasswords2，复选框就会出现了，如下图所示：
<img src={require('@site/static/img/softwareInstall/39.png').default} alt=""/>
