...
<img src={require('@site/static/img/softwareInstall/9.png').default} alt="logo" style={{marginLeft:"4em"}} />
...
<img src={require('@site/static/img/softwareInstall/10.png').default} alt="logo" style={{marginLeft:"4em"}} />
...
<img src={require('@site/static/img/softwareInstall/11.png').default} alt="logo" style={{marginLeft:"4em"}} />
